...
class Planilla extends Controller
{
    ...
    public function create()
    {
        ...
        $moneda = $_POST['moneda'];
        // Inputs numeros
        $muc = $_POST['muc'] == '' ? 0.00 : $_POST['muc'];
        $vet = $_POST['vet'] == '' ? 0.00 : $_POST['vet'];
        $rembasica = $_POST['remBasica'] == '' ? 0.00 : $_POST['remBasica'];
        $remunifi = $_POST['remReunificada'] == '' ? 0.00 : $_POST['remReunificada'];
        $ds276 = $_POST['desupremo'] == '' ? 0.00 : $_POST['desupremo'];
        $remotros = $_POST['otros'] == '' ? 0.00 : $_POST['otros'];
        $ley19990 = $_POST['ley19990'] == '' ? 0.00 : $_POST['ley19990'];
        $ley20530 = $_POST['ley20530'] == '' ? 0.00 : $_POST['ley20530'];
        $afp = $_POST['afp'] == '' ? 0.00 : $_POST['afp'];
        $ipss = $_POST['ipss'] == '' ? 0.00 : $_POST['ipss'];
        $fonavi = $_POST['fonavi'] == '' ? 0.00 : $_POST['fonavi'];
